...
//         try{
// const response = await axios.get(`http://localhost:3007/studentData/${userId}`,{params: {role: role,email:email},});
...
//         }
//     };
// // fetch data only if the iser id available
// useEffect(() => {
//     if(userId && role){
//         fetchData();
//     }
...
//     await axios.delete(`http://localhost:3006/students/${studentId}`)
//     .then((response) => {
...
//       </Link>
//       <Link to = '/recycleBin'><button style={styles.button} type='submit'>RecycleBin</button> </Link>
//       {submittedData && submittedData.map((student) => (
